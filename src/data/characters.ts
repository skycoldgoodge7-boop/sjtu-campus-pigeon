...
export const characters: Character[] = [
...

  {
    ...
    haunt: '电院大草坪',
    traceHint: '草坪那边传来叽叽喳喳的声音。', traceThreshold: 2,
    observationLevels: [
      '它总是在草坪上跳来跳去，嗓门很大。',
  ...
  },
  {
    ...
    haunt: '庙门附近',
    traceHint: '庙门的墙头好像有什么东西在动。', traceThreshold: 2,
    observationLevels: [
  ...
  },
  {
    ...
    haunt: '植物园',
    traceHint: '树上有什么东西嗖地跑过去了。', traceThreshold: 2,
    observationLevels: [
      '它总是在收集坚果，跑得飞快。',
  ...
  },
  {
    ...
    haunt: '思源湖',
    traceHint: '湖面上有一圈圈的波纹。', traceThreshold: 2,
    observationLevels: [
      '游泳健将，性格憨厚，总在湖面上晃悠。',
      '大奇看到鸽子飞过来，会嘎嘎叫两声打招呼。',
  ...
  },
  {
    ...
    haunt: '致远湖',
    traceHint: '远处的湖面上有一个白色的影子。', traceThreshold: 3,
    observationLevels: [
      '优雅的黑天鹅，偶尔会游到湖心亭边。',
  ...
  },
  {
    ...
    haunt: '植物园',
    traceHint: '有什么彩色的东西在花丛间飘过。', traceThreshold: 3,
    observationLevels: [
      '翅膀花纹很美，总是在花丛间飘。',
  ...
  },
  {
    ...
    haunt: '电院大草坪',
    traceHint: '草坪那边好像有个橘色的东西在晒太阳。', traceThreshold: 2,
    observationLevels: [
    ...
    condition: { landmarks: ['seiee-lawn'], timeOfDay: ['afternoon'], moodMin: { slack: 55 } },
...

  {
    ...
    haunt: '电信群楼',
    traceHint: '实验楼有一扇窗还亮着。', traceThreshold: 3,
    observationLevels: [
      '凌晨两点，实验室的灯还亮着。',
    ...
    condition: { landmarks: ['seiee-complex'], timeOfDay: ['night'], moodMin: { academic: 55 }, consecutiveDays: { mood: 'academic', threshold: 50, days: 2 } },
  ...
  },
  {
    ...
    haunt: '思源湖',
    traceHint: '今晚思源湖那边有很轻的吉他声。', traceThreshold: 2,
    observationLevels: [
      '今晚那里有很轻的吉他声。',
    ...
    condition: { landmarks: ['siyuan-lake'], timeOfDay: ['evening', 'night'], moodMin: { social: 55, romance: 45 } },
  ...
  },
  {
    ...
    haunt: '庙门附近',
    traceHint: '远处有手电筒的光晃了一下。', traceThreshold: 2,
    observationLevels: [
  ...
  },
  {
    ...
    haunt: '校园各处',
    traceHint: '天还没亮，远处传来扫地的沙沙声。', traceThreshold: 3,
    observationLevels: [
      '天还没亮的时候，就能听到扫地的沙沙声。',
      '鸽子认得那个节奏。不急不慢，从东到西。',
  ...
  },
  {
    ...
    haunt: '思源湖 / 致远湖',
    traceHint: '湖边有两个人的影子，走得很慢。', traceThreshold: 2,
    observationLevels: [
    ...
    condition: { landmarks: ['siyuan-lake', 'zhiyuan-lake'], timeOfDay: ['evening'], moodMin: { romance: 55 } },
...

  {
    ...
    haunt: '新图书馆',
    traceHint: '图书馆有一排窗户还亮着。', traceThreshold: 3,
    observationLevels: [
    ...
    condition: { landmarks: ['new-library'], timeOfDay: ['night'], campusState: ['exam'], moodMin: { academic: 50 } },
